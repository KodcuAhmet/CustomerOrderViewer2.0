...
namespace CustomerOrderViewer2._0
{
    class Program
    {
        private static string _connectionString = @"Data Source=THINKBOOK14G6\MSSQLSERVER01;Initial Catalog=CustomerOrderViewer;Integrated Security=True;Encrypt=False";
        ...
        public static readonly ItemCommand _itemCommand = new ItemCommand(_connectionString);
        ...
        private static void DisplayCustomerOrders()
        {
            ...
            if (customerOrderDetails.Any())
            {
                ...
                {
                    Console.WriteLine(String.Format("{0}: Full Name: {1} {2} (Id: {3}) - purchased {4} for {5} (Id: {6}",
        ...
        {
            Console.WriteLine("Note: For updating insert existing CustomerOrderId, for new entries -1.");
